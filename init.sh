...
POLYSCAN_API_KEY=
ETHEREUM_API_KEY=
ETHEREUM_SEPOLIA_ID=0xaa36a7
ETHEREUM_SEPOLIA_RPC=https://ethereum-sepolia-rpc.publicnode.com
ETHEREUM_SEPOLIA_EXPLORER=https://sepolia.etherscan.io/
BASESCAN_API_KEY=FH5PXEVPNMPVQTFHJXIS3ERQ955M3IGE4T
...
BOTANIX_TESTNET_ID=0xe34
BOTANIX_TESTNET_RPC=https://node.botanixlabs.dev
BOTANIX_TESTNET_EXPLORER=https://3xpl.com/botanix
BITLAYER_TESTNET_ID=0x3106A
BITLAYER_TESTNET_RPC=https://testnet-rpc.bitlayer.org
BITLAYER_TESTNET_RPC2=https://testnet-rpc.bitlayer-rpc.com
BITLAYER_TESTNET_RPC3=https://rpc.ankr.com/bitlayer_testnet
BITLAYER_TESTNT_EXPLORER=https://testnet-scan.bitlayer.org
" > .env
